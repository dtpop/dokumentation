...
<table width="100%">
	...
	<tr>
		<td>ART_ADDED</td><td>Wird ausgeführt, sobald ein Artikel hinzugefügt wurde.</td>
	</tr>
	<tr>
	...
	<tr>
		<td>ART_CONTENT</td><td>Übergibt den Artikel-Inhalt und erwartet diesen ggf. Verändert zurück.</td>
	</tr>
	<tr>
...
<table width="100%">
	...
	<tr>
		<td>SLICE_SHOW</td><td>Übergibt einen einzelnen Slice als Subject</td>
	</tr>
	<tr>
...
<table width="100%">
	...
	<tr>
		<td>FE_OUTPUT</td><td>Übergibt den gesamten Inhalt der Frontend-Ausgabe als Subject.</td>
	</tr>
	<tr>
	...
	<tr>
		<td>PAGE_TITLE</td><td>Beeinflusst die Überschrift die im Backend über dem Inhalt ausgegeben wird.</td>
	</tr>
	<tr>
		<td>PAGE_TITLE_SHOWN</td><td>Gibt einen String vor <header> im Backend mit <b>echo<b> aus.</td>
	</tr>
	<tr>
		<td>PACKAGES_INCLUDED</td><td>Wird ausgeführt, nachdem alle Addons geladen wurden.</td>
	</tr>
</table>